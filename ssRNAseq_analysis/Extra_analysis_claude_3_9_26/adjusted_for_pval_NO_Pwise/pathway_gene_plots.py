...
for pw_name in pathways:
    ...
    fig.text(0.5, 0.948, "Significance brackets use DESeq2 BH-adjusted padj (not Wilcoxon nominal p)",
    ...
    de_handle   = mlines.Line2D([], [], color="white", marker="*",
                                 ...
                                 label="✦ = DESeq2 sig. (BH-adjusted padj < 0.05)")
    star_note   = mpatches.Patch(color="none",
                                  label="Brackets: ↑/↓log2FC — BH-adjusted padj  *<.05  **<.01  ***<.001  ·<.1")
