...
| `DESeq2_Free_vs_Pygostyle_by_ENS.csv` | Input: DESeq2 results (gene symbols + log2FC + padj) |
...
python3 build_3d_network.py \
  ...
  --deseq2-csv DESeq2_Free_vs_Pygostyle_by_ENS.csv \
...
|----------|----------|---------|-------------|
| `--r-script` | Yes | — | Path to `pathway_mapper_v4.R` |
