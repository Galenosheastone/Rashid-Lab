...
pathway_registry[["cgas_sting"]] <- function() {
  ...
  edges <- tribble(
    ~from,     ~to,       ~edge_class, ~edge_pathway,  ~edge_sign,
    "DDX41",   "STING1",  "core",      "cgas_sting",   "activating",
    "IFI16",   "STING1",  "core",      "cgas_sting",   "activating",
    "MB21D1",  "STING1",  "core",      "cgas_sting",   "activating",
    "ZBP1",    "TBK1",    "core",      "cgas_sting",   "activating",
    "STING1",  "TRAF3",   "core",      "cgas_sting",   "activating",
    "STING1",  "TRAF6",   "core",      "cgas_sting",   "activating",
    "TRAF3",   "TBK1",    "core",      "cgas_sting",   "activating",
    "TRAF6",   "IKBKB",   "core",      "cgas_sting",   "activating",
    "IKBKG",   "IKBKB",   "core",      "cgas_sting",   "activating",
    "STING1",  "TBK1",    "core",      "cgas_sting",   "activating",
    "STING1",  "IKBKB",   "core",      "cgas_sting",   "activating",
    "CHUK",    "NFKB1",   "core",      "cgas_sting",   "activating",
    "IKBKB",   "NFKB1",   "core",      "cgas_sting",   "activating",
    "IKBKB",   "RELA",    "core",      "cgas_sting",   "activating",
    "TBK1",    "IRF3",    "core",      "cgas_sting",   "activating",
    "TBK1",    "IRF7",    "core",      "cgas_sting",   "activating",
    "IRF3",    "IFNB1",   "core",      "cgas_sting",   "activating",
    "IRF7",    "IFNB1",   "core",      "cgas_sting",   "activating",
    "IFNB1",   "IFNAR1",  "core",      "cgas_sting",   "activating",
    "IFNB1",   "IFNAR2",  "core",      "cgas_sting",   "activating",
    "IFNAR1",  "JAK1",    "core",      "cgas_sting",   "activating",
    "IFNAR2",  "TYK2",    "core",      "cgas_sting",   "activating",
    "JAK1",    "STAT1",   "core",      "cgas_sting",   "activating",
    "TYK2",    "STAT2",   "core",      "cgas_sting",   "activating",
    "STAT1",   "IRF9",    "core",      "cgas_sting",   "activating",
    "STAT2",   "IRF9",    "core",      "cgas_sting",   "activating",
    "IRF9",    "ISG15",   "output",    "cgas_sting",   "activating",
    "IRF9",    "MX1",     "output",    "cgas_sting",   "activating",
    "IRF9",    "OASL",    "output",    "cgas_sting",   "activating",
    "IRF9",    "IFIT5",   "output",    "cgas_sting",   "activating",
    "IRF9",    "RSAD2",   "output",    "cgas_sting",   "activating",
    "RELA",    "IL6",     "output",    "cgas_sting",   "activating",
    "RELA",    "TNF",     "output",    "cgas_sting",   "activating",
    "IRF3",    "CXCL10",  "output",    "cgas_sting",   "activating",
    "IRF7",    "CCL5",    "output",    "cgas_sting",   "activating"
  )
...
pathway_registry[["apoptosis"]] <- function() {
  ...
  edges <- tribble(
    ~from,      ~to,        ~edge_class, ~edge_pathway,         ~edge_sign,
    "TNF",      "TNFRSF1A", "core",      "shared_death_input",  "activating",
    "TNFRSF1A", "TRADD",    "core",      "shared_death_input",  "activating",
    "TRADD",    "FADD",     "core",      "apoptosis_branch",    "activating",
    "FADD",     "CASP8",    "core",      "apoptosis_branch",    "activating",
    "CASP8",    "CASP3",    "output",    "apoptosis_branch",    "activating",
    "CASP8",    "CASP7",    "output",    "apoptosis_branch",    "activating",
    "CASP8",    "BID",      "core",      "apoptosis_branch",    "activating",
    "BID",      "BAX",      "core",      "apoptosis_branch",    "activating",
    "BAX",      "CYCS",     "core",      "apoptosis_branch",    "activating",
    "CYCS",     "APAF1",    "core",      "apoptosis_branch",    "activating",
    "APAF1",    "CASP9",    "core",      "apoptosis_branch",    "activating",
    "CASP9",    "CASP3",    "output",    "apoptosis_branch",    "activating"
  )
...
pathway_registry[["necroptosis"]] <- function() {
  ...
  edges <- tribble(
    ...
    "TNF",      "TNFRSF1A", "core",      "shared_death_input",  "activating",
    "TNFRSF1A", "TRADD",    "core",      "shared_death_input",  "activating",
    "TRADD",    "RIPK1",    "core",      "necroptosis_branch",  "activating",
    "RIPK1",    "RIPK3",    "core",      "necroptosis_branch",  "activating",
    "RIPK3",    "MLKL",     "output",    "necroptosis_branch",  "activating",
    "ZBP1",     "RIPK3",    "core",      "necroptosis_branch",  "activating",
    "CASP8",    "RIPK1",    "core",      "necroptosis_branch",  "inhibitory"
  )
...
pathway_registry[["inflammasome"]] <- function() {
  ...
  edges <- tribble(
    ~from,       ~to,        ~edge_class, ~edge_pathway, ~edge_sign,
    # Priming arm
    "TLR4",      "MYD88",    "core",      "priming",     "activating",
    "MYD88",     "IRAK4",    "core",      "priming",     "activating",
    "IRAK4",     "TRAF6",    "core",      "priming",     "activating",
    "TRAF6",     "NFKB1",    "core",      "priming",     "activating",
    "TRAF6",     "RELA",     "core",      "priming",     "activating",
    "NFKB1",     "NLRP3_tx", "output",    "priming",     "activating",
    "RELA",      "IL1B_tx",  "output",    "priming",     "activating",
    # Sensor assembly
    "NEK7",      "NLRP3",    "core",      "activation",  "activating",
    "TXNIP",     "NLRP3",    "core",      "activation",  "activating",
    "NLRP3",     "PYCARD",   "core",      "activation",  "activating",
    "AIM2",      "PYCARD",   "core",      "activation",  "activating",
    "NLRC4",     "PYCARD",   "core",      "activation",  "activating",
    "PYCARD",    "CASP1",    "core",      "activation",  "activating",
    # Effector outputs
    "CASP1",     "IL1B",     "output",    "effector",    "activating",
    "CASP1",     "IL18",     "output",    "effector",    "activating",
    "CASP1",     "GSDMD",    "output",    "effector",    "activating"
  )
...
pathway_registry[["osteoclast"]] <- function() {
  ...
  edges <- tribble(
    ~from,          ~to,          ~edge_class, ~edge_pathway,   ~edge_sign,
    # M-CSF survival axis
    "CSF1",         "CSF1R",      "core",      "csf1_survival", "activating",
    # RANKL-RANK core
    "TNFSF11",      "TNFRSF11A",  "core",      "rankl_rank",    "activating",
    "TNFRSF11B",    "TNFSF11",    "core",      "rankl_rank",    "inhibitory",
    "TNFRSF11A",    "TRAF6",      "core",      "rankl_rank",    "activating",
    "TRAF6",        "MAP3K7",     "core",      "rankl_rank",    "activating",
    "MAP3K7",       "MAPK14",     "core",      "rankl_rank",    "activating",
    "MAP3K7",       "MAPK1",      "core",      "rankl_rank",    "activating",
    "MAP3K7",       "NFKB1",      "core",      "rankl_rank",    "activating",
    # MAPK → AP-1 → NFATc1
    "MAPK14",       "JUN",        "core",      "rankl_rank",    "activating",
    "MAPK1",        "FOS",        "core",      "rankl_rank",    "activating",
    "JUN",          "NFATC1",     "core",      "rankl_rank",    "activating",
    "FOS",          "NFATC1",     "core",      "rankl_rank",    "activating",
    "NFKB1",        "NFATC1",     "core",      "rankl_rank",    "activating",
    # NFATc1 → markers
    "NFATC1",       "ACP5",       "output",    "oc_output",     "activating",
    "NFATC1",       "CTSK",       "output",    "oc_output",     "activating",
    "NFATC1",       "MMP9",       "output",    "oc_output",     "activating",
    "NFATC1",       "CALCR",      "output",    "oc_output",     "activating",
    "NFATC1",       "DCSTAMP",    "output",    "oc_output",     "activating"
  )
...
pathway_registry[["osteoblast"]] <- function() {
  ...
  edges <- tribble(
    ~from,      ~to,       ~edge_class, ~edge_pathway,         ~edge_sign,
    # BMP axis
    "BMP2",     "BMPR1A",  "core",      "bmp_signaling",       "activating",
    "BMP4",     "BMPR1A",  "core",      "bmp_signaling",       "activating",
    "BMP7",     "BMPR2",   "core",      "bmp_signaling",       "activating",
    "BMPR1A",   "SMAD1",   "core",      "bmp_signaling",       "activating",
    "BMPR2",    "SMAD5",   "core",      "bmp_signaling",       "activating",
    "SMAD1",    "SMAD4",   "core",      "bmp_signaling",       "activating",
    "SMAD5",    "SMAD4",   "core",      "bmp_signaling",       "activating",
    "SMAD4",    "RUNX2",   "core",      "bmp_signaling",       "activating",
    # Wnt axis
    "WNT3A",    "FZD1",    "core",      "wnt_signaling",       "activating",
    "WNT3A",    "LRP5",    "core",      "wnt_signaling",       "activating",
    "WNT3A",    "LRP6",    "core",      "wnt_signaling",       "activating",
    "FZD1",     "DVL2",    "core",      "wnt_signaling",       "activating",
    "DVL2",     "GSK3B",   "core",      "wnt_signaling",       "activating",
    "GSK3B",    "APC",     "core",      "wnt_signaling",       "activating",
    "GSK3B",    "AXIN2",   "core",      "wnt_signaling",       "activating",
    "DVL2",     "CTNNB1",  "core",      "wnt_signaling",       "activating",
    "CTNNB1",   "RUNX2",   "core",      "wnt_signaling",       "activating",
    # Negative regulators → Wnt (inhibitory)
    "SOST",     "LRP5",    "core",      "wnt_inhibition",      "inhibitory",
    "DKK1",     "LRP6",    "core",      "wnt_inhibition",      "inhibitory",
    # TF cascade
    "RUNX2",    "SP7",     "core",      "ob_differentiation",  "activating",
    "SP7",      "ATF4",    "core",      "ob_differentiation",  "activating",
    # TF → markers
    "RUNX2",    "COL1A1",  "output",    "ob_output",           "activating",
    "RUNX2",    "ALPL",    "output",    "ob_output",           "activating",
    "SP7",      "BGLAP",   "output",    "ob_output",           "activating",
    "SP7",      "SPP1",    "output",    "ob_output",           "activating",
    "ATF4",     "BGLAP",   "output",    "ob_output",           "activating",
    "ATF4",     "IBSP",    "output",    "ob_output",           "activating"
  )
...
pathway_registry[["oxysterol"]] <- function() {
  ...
  edges <- tribble(
    ...
    "IFNB1",     "IFNAR1",    "core",       "ifn_input",            "activating",
    "IFNAR1",    "CH25H",     "core",       "ifn_input",            "activating",
    # Biosynthesis: CH25H → 25-HC → CYP7B1 → 7α,25-diHC
    "CH25H",     "CYP7B1",    "core",       "biosynthesis",         "activating",
    "CH25H",     "NR1H3",     "core",       "lxr_arm",              "activating",
    "CH25H",     "INSIG1",    "core",       "cholesterol_sensing",  "activating",
    # CYP7B1 → GPR183 ligand
    "CYP7B1",    "GPR183",    "output",     "chemotaxis_arm",       "activating",
    # GPR183 gradient sculpting (HSD3B7 degrades ligand → inhibitory to GPR183 signaling)
    "HSD3B7",    "GPR183",    "core",       "chemotaxis_arm",       "inhibitory",
    # CYP11A1 → osteogenic oxysterols → SMO
    "CYP11A1",   "SMO",       "core",       "hedgehog_arm",         "activating",
    # CYP27A1 → 27-OHC → LXR
    "CYP27A1",   "NR1H3",     "core",       "lxr_arm",              "activating",
    # Hedgehog arm: SMO → GLI → HES/HEY → RUNX2/SP7
    "PTCH1",     "SMO",       "core",       "hedgehog_arm",         "inhibitory",
    "SMO",       "GLI1",      "core",       "hedgehog_arm",         "activating",
    "SMO",       "GLI2",      "core",       "hedgehog_arm",         "activating",
    "GLI1",      "HES1",      "core",       "hedgehog_arm",         "activating",
    "GLI1",      "HEY1",      "core",       "hedgehog_arm",         "activating",
    "GLI2",      "HES1",      "core",       "hedgehog_arm",         "activating",
    "HES1",      "RUNX2",     "output",     "hedgehog_arm",         "activating",
    "HEY1",      "RUNX2",     "output",     "hedgehog_arm",         "activating",
    "RUNX2",     "SP7",       "output",     "hedgehog_arm",         "activating",
    # LXR arm: NR1H3 → efflux transporters + RANKL
    "NR1H3",     "ABCA1",     "output",     "lxr_arm",              "activating",
    "NR1H3",     "ABCG1",     "output",     "lxr_arm",              "activating",
    "NR1H3",     "TNFSF11",   "output",     "lxr_arm",              "activating",
    # Cholesterol sensing: 25-HC → INSIG1 → SCAP → SREBF2 → HMGCR
    "INSIG1",    "SCAP",      "core",       "cholesterol_sensing",  "activating",
    "SCAP",      "SREBF2",    "core",       "cholesterol_sensing",  "activating",
    "SREBF2",    "HMGCR",     "output",     "cholesterol_sensing",  "activating",
    # Degradation
    "SULT2B1",   "CH25H",     "core",       "degradation",          "activating"
  )
...
build_pathway_plot <- function(node_tbl,
  ...
  if (!"edge_sign" %in% names(edge_df)) {
    edge_df <- edge_df %>% mutate(edge_sign = "activating")
  }
  edge_df <- edge_df %>%
    mutate(
